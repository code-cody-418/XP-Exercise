  ...
  try {
    ...
    passport.authenticate(
      ...
      async (err: any, passportUser: Profile) => {
        ...
        const {profileId, profileUserName, profileAvatarUrl, profileEmail} = passportUser;
        const signature: string = uuid();
        const authorization: string = generateJwt({profileId, profileUserName, profileAvatarUrl, profileEmail}, signature);
